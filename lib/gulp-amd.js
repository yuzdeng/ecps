...
function grepDepList(entryFilePath, sourceRoot, recursion) {
            ...
            depIds.reverse().forEach(function (dependedModuleId) {
                ...
                if (dependedModuleId) {
                    if (/\.js$/.test(dependedModuleId)) {
                        Util.warn('The module Id end with .js, it usually ignore the suffix ".js"');
                    ...
                    try {
                        ...
                        Util.error('Can\'t find the fullDependedModuleFilePath: ' + fullDependedModuleFilePath)
                    }
...
// Build JS (AMD)
function buildJsUtil(entryFilePath, sourceRoot, ignores) {
    ignores = ignores || [];

    var dependedModuleIdList = grepDepList(entryFilePath, sourceRoot, true);
...
module.exports = function (options) {
    ...
    return through2.obj(function (file, enc, callback) {
        ...
        var contents = buildJsUtil(file.path, options.sourceRoot, options.ignores);
